-- public.org_id() helper function
-- NOTE: This function is defined in 00004_rls_policies.sql where it is first needed.
-- This file exists as a reference for the public.org_id() pattern.
-- The function is created with CREATE OR REPLACE so this is safe to run.
--
-- The public.org_id() function returns the org_id for the currently authenticated user.
-- Wrap in (select public.org_id()) in RLS policies for initPlan caching.
